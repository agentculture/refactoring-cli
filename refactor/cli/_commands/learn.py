"""``refactoring-cli learn`` — the learnability affordance.
...
from refactor.cli._output import emit_result

_TEXT = """\
refactoring-cli — a clonable template for AgentCulture mesh agents.
...
Commands
--------
  refactoring-cli whoami             Identity from culture.yaml.
  refactoring-cli learn              This self-teaching prompt.
  refactoring-cli explain <path>...  Markdown docs for any noun/verb path.
  refactoring-cli overview           Descriptive snapshot of the agent.
  refactoring-cli doctor             Check the agent-identity invariants.
  refactoring-cli cli overview       Describe the CLI surface itself.
...
def _as_json_payload() -> dict[str, object]:
    return {
        ...
        "json_support": True,
        "explain_pointer": "refactoring-cli explain <path>",
    }
