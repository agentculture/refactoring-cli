...
Every failure inside refactoring-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`refactor.cli._output`,
...
# Exit-code policy. Documented in ``refactoring-cli learn`` output.
# 0      = success
