...
uv run refactoring-cli whoami  # identity from culture.yaml
uv run refactoring-cli learn   # self-teaching prompt (add --json)
...
1. Rename the package `refactor/` and the `refactoring-cli`
